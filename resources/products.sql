...
('mens clothing'), ('jewelry'), ('electronics');
INSERT INTO
...
values
  (
    ...
    (select c.category_id from categories c where c.name = 'electronics'),
  ...
  (
    ...
    (select c.category_id from categories c where c.name = 'mens clothing'),
  ...
  (
    ...
    (select c.category_id from categories c where c.name = 'jewelry'),
